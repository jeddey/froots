 ...
 *
 * @method null|OrderProducts find($id, $lockMode = null, $lockVersion = null)
 * @method null|OrderProducts findOneBy(array $criteria, array $orderBy = null)
...
class OrderProductsRepository extends ServiceEntityRepository
{
    ...
    public function add(OrderProducts $entity, bool $flush = false): void
    {
